...
public class TestTutteEmbedding {
    List<Double> xValues;
    List<Double> yValues;
    List<String> edges;
    ...
    public TestTutteEmbedding(List<Double> xValues, List<Double> yValues, List<String> edges, List<List<Integer>> regions, List<List<Integer>> rotationSystem, List<Integer> regionToPin){
